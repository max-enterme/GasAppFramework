...
export namespace Engine {
    ...
    export function create<TEntity extends object, Key extends keyof TEntity>(deps: {
        schema: Ports.Schema<TEntity, Key>
        store: Ports.Store<TEntity>
        keyCodec: Ports.KeyCodec<TEntity, Key>
...
export namespace Adapters.Memory {
    export class Store<TEntity extends object> implements Ports.Store<TEntity> {
        private arr: TEntity[] = [];
...
export namespace Codec {
    export function simple<TEntity extends object, Key extends keyof TEntity>(keyFields?: string[], delim = '|') {
        ...
        } as Ports.KeyCodec<TEntity, Key>;
    }

}

export class RepositoryError extends Error {
        constructor(public code: Types.ErrorCode, message: string) {
            super(message);
